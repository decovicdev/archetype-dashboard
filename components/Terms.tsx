  ...
  <MainLayout>
    ...
    <div className="p-20">
      ...
      <p className="text-justify my-2">
        ...
        YOU MAY NOT ACCESS OR USE THE SERVICES OR ACCEPT THE TERMS IF YOU ARE
      ...
      <p className="text-justify my-2">
        ...
        <b>“Third-Party Account”</b> is a valid account on a third-party website
        or service through which the user has connected to the Services. You
      ...
      <p className="text-justify my-2">
        ...
        BY FOLLOWING THE UNSUBSCRIBE OPTIONS IN THE PROMOTIONAL EMAIL ITSELF. IF
        YOU WISH TO OPT OUT OF PROMOTIONAL CALLS OR TEXTS, YOU MAY TEXT “END” TO
        [____] FROM THE MOBILE DEVICE RECEIVING THE MESSAGES. YOU ACKNOWLEDGE
        THAT YOU ARE NOT REQUIRED TO CONSENT TO RECEIVE PROMOTIONAL TEXTS OR
        CALLS AS A CONDITION OF USING THE SERVICES. IF YOU WISH TO OPT OUT OF
        ALL TEXTS OR CALLS FROM US (INCLUDING OPERATIONAL OR TRANSACTIONAL TEXTS
        OR CALLS), YOU CAN TEXT THE WORD “STOPALL” TO [___] FROM THE MOBILE
      ...
      <p className="text-justify my-2">
        ...
        reverse engineer any part of the Services; (c) you shall not access the
        ...
        addition to functionality of the Services shall be subject to these
        Terms. All copyright and other proprietary notices on the Services (or
      ...
      <p className="inner1">
        ...
        transmit, display, or distribute any User Content that: (i) violates any
        ...
        is otherwise objectionable; (iii) is harmful to minors in any way; or
        (iv) is in violation of any law, regulation, or obligations or
      ...
      <p className="inner1">
        ...
        any software intended to damage or alter a computer system or data; (ii)
        send through the Services unsolicited or unauthorized advertising,
        promotional materials, junk mail, spam, chain letters, pyramid schemes,
        or any other form of duplicative or unsolicited messages, whether
        commercial or otherwise; (iii) use the Services to harvest, collect,
        gather or assemble information or data regarding other users, including
        e-mail addresses, without their consent; (iv) interfere with, disrupt,
        or create an undue burden on servers or networks connected to the
        Services, or violate the regulations, policies or procedures of such
        networks; (v) attempt to gain unauthorized access to the Services (or to
        ...
        from) the Services (provided, however, that we conditionally grant to
        the operators of public search engines revocable permission to use
        spiders to copy materials from the Services for the sole purpose of and
      ...
      <p className="text-justify my-2">
        ...
        measured by sales proceeds that is the functional equivalent of a sales
      ...
      <p className="inner1">
        ...
        price volatility. We cannot and do not guarantee that any purchasers of
        digital assets will not lose money.
      </p>
      <p className="inner1">
      ...
      <p className="inner1">
        <b>(c)</b> Digital assets exist and can be transferred only by virtue of
        the ownership record maintained on the blockchain supporting such
        digital assets.
      </p>
      <p className="inner1">
      ...
      <p className="inner1">
        ...
        regulations or policies may materially adversely affect the development
        of the Services and the utility of digital assets.
      </p>
      <p className="inner1">
      ...
      <p className="inner1">
        ...
        product liability claims; (ii) any claim that the Mobile App fails to
      ...
      <p className="text-justify my-2">
        ...
        to, the Services (including any interactions with, or act or omission
        of, other Services users or any Third-Party Links & Ads). IF YOU ARE A
      ...
      <p className="inner1">
        ...
        to the method of initiating and/or demanding arbitration, except to the
        extent such rules are in conflict with the Terms. The AAA Consumer
        Arbitration Rules (<b>“Arbitration Rules”</b>) governing the arbitration
        are available online at www.adr.org or by calling the AAA at
      ...
      <p className="inner1">
        ...
        compliance therewith, shall be strictly confidential. The parties agree
      ...
      <p className="inner1">
        <b>(j)</b> <i>Severability.</i> If any part or parts of this Arbitration
      ...
      <p className="inner1">
        <b>(o)</b> <i>Claims Not Subject to Arbitration.</i> Notwithstanding the
